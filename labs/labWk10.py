...
word_info_sz      = 256 # Size of output vector for each word.
                      # This can be changed.
                      
# Stores info about word sequence - 
# "Eat to live" vs. "Live to eat" are very different.
sentence_info_sz  = 300 # Vector size for storing info about
                      # entire sequence.
                      # This can be changed.
batch_size        = 32
...
history = model.fit(X_train, Y_train, batch_size =batch_size, epochs =12,
